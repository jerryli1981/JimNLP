...
public class GoogleNewsCorpus extends InstanceList implements Serializable {

	public GoogleNewsCorpus(Iterator<Instance> ii, PipeLine pipeLine) {
		super(pipeLine);
		addThruPipe(ii);
	}

	public GoogleNewsCorpus(InstanceList docs, PipeLine pipeLine) {
		super(pipeLine);
